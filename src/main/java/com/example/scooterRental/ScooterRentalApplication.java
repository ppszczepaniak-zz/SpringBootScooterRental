...
//INFO: this is usually NOT necessary if all packages are "below" main class, as in this app
// in order to properly load components which represent controller, model, repository,... we add this annotation (@ComponentScan),
